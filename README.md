...
- **[Дизайн архитектуры](https://app.diagrams.net/?lang=en/#G11At2G5mZ-JMfmA6tRvXmPy5N2Jv4FLdJ)**
...
- `feature/<meaningful-name>` - ветки функциональностей - используются для разработки новых функций. Могут порождаться из ветки `develop` или других `feature/` веток
- `fix/<meaningful-name|issue id>` - ветки исправлений - используются для немедленного исправления ошибок. Могут порождаться из `main` или `develop` 
...
- `general/<meaningful-name>` - документация, изменения файлы, не связанных с кодом приложения. Может порождаться из `main`
- `devops/<meaningful-name>` - изменения конфигураций, скриптов сборки, CI/CD. Может порождаться из `main`
