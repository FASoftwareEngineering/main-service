...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('default', 'active', 'paused', 'finished', name='projectstatuses'), nullable=True),
    ...
    sa.Column('type', sa.Enum('employee', 'manager', 'project_owner', 'project_manager', name='usertypes'), nullable=True),
    ...
    op.create_table('owners_projects_link',
